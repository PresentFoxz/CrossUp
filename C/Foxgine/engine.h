...
void addObjectToWorld(Vect3f pos, Vect3f rot, Vect3f size, Camera_t cCam, float depthCorrect, int triCount, Vect3f* data, int* backFace, int* colorArray, int flipped, int outline, int lineDraw, int distMod);
